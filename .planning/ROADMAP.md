...
| 4. Refactor Scoring + DB | 0/4 | Planned | - |
...
Plans:
- [ ] 04-01-PLAN.md — Foundation: ListingObservation + DailyListingSummary DB models, PlayerScore extension, config constants, liveAuctions field extraction
- [ ] 04-02-PLAN.md — Listing tracker: fingerprint upsert, outcome resolution, daily aggregation
- [ ] 04-03-PLAN.md — Scorer v2: expected_profit_per_hour from accumulated listing data (D-10 formula)
