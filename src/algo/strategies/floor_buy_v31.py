"""Floor buy v31 — v21 with relaxed fresh-signal gate.

v21 baseline: +$502k / 93.8% win / 16 trades / W14 $0 / W15 +$29k / W16 +$473k.
Only 16 trades over 27 days — signal is scarce. Relax recent_h_min 24→6 to
admit entries after only 6h of floor-touching history. Raise max_positions
8→12 to absorb the increased signal flow. Keep everything else v21-identical.
"""
import logging
...
class FloorBuyV31Strategy(Strategy):
    name = "floor_buy_v31"
