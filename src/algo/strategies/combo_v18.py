"""Combo v18 — v15 with middle arm swapped to v37 (W13/W14-only BUYs).

combo_v15/v17 suffer cannibalization: v36 fires on the same $10-13k floor band
as v19 and in W15+ takes the best entries, leaving v19 with worse cards and
gutting W16 harvest. v37 = v36 with BUYs restricted to iso-weeks 13 and 14 only;
outside that window, v37 emits no buys so v19 has exclusive access to W15+
entries.

Budgets: v19 $650k (full W16 harvest) + v37 $200k (W13/W14 only) + v23 $150k
(corr support).
"""
import logging
...
class ComboV18Strategy(Strategy):
    name = "combo_v18"
    ...
    def on_tick_batch(
        ...
        # ── v37 arm — gated by its $200k local cash ──
