"""Floor buy v32 — v21 with band shifted DOWN to cheaper cohort.

v21 baseline: +$502k / 93.8% win / 16 trades / W14 $0 / W15 +$29k / W16 +$473k.
Passed 4/6 bars (fails W14 and corr -0.83).

This iteration: shift the entire band DOWN to even-cheaper cards.
- min_price: 10000 → 8500
- floor_ceiling: 13000 → 11500
- floor_stable: 14500 → 13000
- week_max_ceiling: 18000 → 15000

Theory: cheaper cards may have earlier floor-touches in W14 where the
v21 band saw nothing. Different cohort density may also decorrelate
from promo_dip_buy_filtered. Everything else v21-identical.
"""
import logging
...
class FloorBuyV32Strategy(Strategy):
    name = "floor_buy_v32"
