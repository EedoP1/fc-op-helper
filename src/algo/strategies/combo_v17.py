"""Combo v17 — TRIPLE-arm rebalance (v19 $500k + v36 $300k + v23 $200k).

Iter 42: v16 ($700k/$150k/$150k) scored poorly with W16 -$78.5k and 71%
boundary (force-sells). Shrink v19 to $500k to reduce force-sell burden,
grow v36 to $300k for stronger W14 margin, boost v23 to $200k for W15
and corr support.

Three-arm:
  - v19 (FloorBuyV19Strategy):   $500k — primary W16 harvest (down from $700k)
  - v36 (FloorBuyV36Strategy):   $300k — W14/W15 fast-cycle (up from $150k)
  - v23 (PostDumpV23Strategy):   $200k — corr support (DoW-gated trig_a)
...
class ComboV17Strategy(Strategy):
    name = "combo_v17"
