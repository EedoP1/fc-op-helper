"""Floor buy v36 — v19 fast-cycle test (max_hold 96h, profit_target 8%).

v35 at 15%/72h: W14 +$1.7k, org -$43k. 15% too aggressive for 72h bounces.
This iter drops target to 8% (just above pessimistic loader's 9.6% drag) and
bumps max_hold to 96h. If W14 organic ≥ +$20k at 8% target, the fast-cycle
concept lives → build a combo next. If still ≤$0, W14 bar 2a is structurally
unreachable under pessimistic loader + liquidity filter.
...
class FloorBuyV36Strategy(Strategy):
    name = "floor_buy_v36"
