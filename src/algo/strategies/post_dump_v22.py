"""Post-dump v22 — v15 + multi-window trend confirm (d72>0 AND d24>d48). Filters dumps inside sustained downtrends."""
import logging
...
class PostDumpV22Strategy(Strategy):
    name = "post_dump_v22"
