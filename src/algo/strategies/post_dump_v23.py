"""Post-dump v23 — v15 + Sun/Mon/Tue DoW gate on trig_a (recovery-phase per original EDA)."""
import logging
...
class PostDumpV23Strategy(Strategy):
    name = "post_dump_v23"
    ...
    def on_tick_batch(
        ...
        # v23: restrict to Sun/Mon/Tue (recovery-phase per original EDA)
