"""Floor buy v33 — v19 with shortened history (burn_in 24h, week_window 72h) to test W14 signal availability."""
import logging
...
class FloorBuyV33Strategy(Strategy):
    name = "floor_buy_v33"
    ...
    def __init__(self, params: dict):
        ...
        self.week_window_h: int = params.get("week_window_h", 72)
