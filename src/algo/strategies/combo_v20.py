"""Combo v20 — boost v19 to $700k, shrink v37 to $150k, keep v23 $150k.

Hypothesis: v18 (650/200/150) only misses W15 bar 2b. Boost v19 budget to $700k
to claim more of its standalone W15 contribution proportionally; shrink v37 to
$150k to reduce cannibalization on other weeks. Keep v23 at $150k for corr
support.

Budgets: v19 $700k + v37 $150k + v23 $150k.
"""
import logging
...
class ComboV20Strategy(Strategy):
    name = "combo_v20"
    ...
    def on_tick_batch(
        ...
        # ── v37 arm — gated by its $150k local cash ──
