"""Floor buy v35 — Fast cycle — 3-day hold, 15% target, sells land same week as buys.

Diagnostic standalone run: v19 body unchanged except max_hold_h 240→72 and
profit_target 0.50→0.15. If W14 organic > +$20k alone, fast-cycle unlocks
bar 2a and we can design a combo around it.
"""
import logging
...
class FloorBuyV35Strategy(Strategy):
    name = "floor_buy_v35"
