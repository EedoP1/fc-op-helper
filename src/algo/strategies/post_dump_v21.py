"""Post-dump v21 — tighter recovery gate (12h/+1.2% vs v15's 6h/+0.4%) to filter dead-cat bounces on 27-day data."""
import logging
...
class PostDumpV21Strategy(Strategy):
    name = "post_dump_v21"
