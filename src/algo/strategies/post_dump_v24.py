"""Post-dump v24 — v23 with SHORT burn_in (24h instead of 72h).

Hypothesis: combo_v10 hits 4/6 bars but fails W14 ($0) and W15. v23's 72h
burn_in delays activation to ~Mar 29, missing early-W14 (Apr 6+) market
activity. Lowering burn_in to 24h activates the arm from ~Mar 27, giving
a wider window to fire trig_a/trig_b on W14 cards.

All other params identical to v23 — DoW-gated trig_a (Sun/Mon/Tue),
dump -3.5% over 48h, recovery +0.4% over 6h, cooldown 48h, profit
target 15%, stop loss 10% after 36h, max hold 120h.
"""
import logging
...
class PostDumpV24Strategy(Strategy):
    name = "post_dump_v24"
    ...
    def on_tick_batch(
        ...
        # Trigger A: rapid dump + recovery — DoW-gated Sun/Mon/Tue
