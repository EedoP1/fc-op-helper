"""Combo v16 — TRIPLE-arm complementary-weeks stack (v19 $700k + v36 $150k + v23 $150k).

Iter 41: v15 scored 4/6 with W16 -$51k because v36 at $250k cannibalized
v19's W16 harvest. Shrink v36 to $150k and redirect $100k to v19 so its
W16 harvest gets more fuel while v36 still contributes fast-cycle W14/W15
profit. v23 unchanged at $150k for corr support.

Three-arm:
  - v19 (FloorBuyV19Strategy):   $700k — primary W16 harvest (up from $600k)
  - v36 (FloorBuyV36Strategy):   $150k — W14/W15 fast-cycle (down from $250k)
...
class ComboV16Strategy(Strategy):
    name = "combo_v16"
    ...
    def on_tick_batch(
        ...
        # ── v36 arm — gated by its $150k local cash ──
