"""Floor buy v38 — v36 with buy-gate for W13/W14/W15. Adds W15 coverage vs v37.

Purpose: used as the middle arm in combo_v19. v37 was restricted to W13/W14
only, leaving v36's natural W15 contribution on the table. v38 extends the
BUY gate to include W15, but still blocks W16 buys so v19 retains exclusive
access to the W16 harvest window. SELLs process normally at any week so open
positions exit at 8% target / 10% stop / 96h max_hold as usual.

All other logic identical to v37 (and v36).
"""
import logging
...
class FloorBuyV38Strategy(Strategy):
    name = "floor_buy_v38"
    ...
    def on_tick_batch(
        ...
        for ea_id, price in ticks:
            ...
            # Week gate: only fire BUYs in iso-weeks 13, 14, or 15.
            iso_week = ts_clean.isocalendar()[1]
            if iso_week > 15:
                continue
