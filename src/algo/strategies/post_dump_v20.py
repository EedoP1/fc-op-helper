"""Post-dump v20 — v15 + 72h global trend veto to skip dead-cat bounces during sustained downtrends."""
import logging
...
class PostDumpV20Strategy(Strategy):
    name = "post_dump_v20"
    ...
    def on_tick_batch(
        ...
        # 72h global trend veto — skip dead-cat bounces during sustained downtrends
        g72 = self._g_delta(72)
        ...
        # Apply veto: if 72h global trend is negative, skip both triggers
        if g72 < 0.0:
            trig_a = False
            trig_b = False
