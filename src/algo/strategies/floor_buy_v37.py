"""Floor buy v37 — v36 variant restricted to fire BUYs ONLY in W13/W14.

Purpose: used as the middle arm in combo_v18 to eliminate cannibalization with
v19. v36 fires on the same $10-13k band as v19 and in combos it takes the best
entries in W15+, starving v19's W16 harvest. v37 caps BUY emission to iso-weeks
13 or 14 (outside this window, no buys). SELLs process normally so any open
...
class FloorBuyV37Strategy(Strategy):
    name = "floor_buy_v37"
    ...
    def on_tick_batch(
        ...
        for ea_id, price in ticks:
            ...
            # Week gate: only fire BUYs in iso-weeks 13 or 14.
