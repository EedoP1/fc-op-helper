"""Sweep delay with the strong sell signal (24h lookback, 5% threshold, 3h confirm)."""
...
async def main():
    ...
    print(f"{'delay':>5} {'PnL':>10} {'#':>3} {'W%':>5} {'Sharpe':>7}  {'Mar20':>14} {'Mar27':>14} {'Apr3':>14}  {'Open':>4}")
    print("-" * 100)

    for delay in [0, 12, 24, 36, 48, 60, 72, 84, 96, 108, 120, 144]:
        params = {
            ...
            # Strong sell signal
            "sell_lookback": 24, "sell_trend_pct": 0.05, "sell_confirm_hours": 3,
            "stop_delay_hours": delay,
        }
        ...
        print(f"{delay:>5} {r['total_pnl']:>+10,} {r['total_trades']:>3} {r['win_rate']:>4.0%} {r['sharpe_ratio']:>7.3f}  {fmt_batch(bp,'03-20'):>14} {fmt_batch(bp,'03-27'):>14} {fmt_batch(bp,'04-03'):>14}  {open_count:>4}")

    # Trades for best combos
    print(f"\n{'='*120}")
    for delay in [72, 84, 96]:
        params = {
            "trend_lookback": 12, "min_day": 0, "max_day": 999, "min_crash": 0.05,
            "trailing_stop": 1.0, "max_hold_hours": 336,
            "min_price": 12000, "max_price": 61000, "max_position_pct": 0.10,
